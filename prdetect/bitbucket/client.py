...
This is the only way the project reaches a repository. It sends GET requests and
nothing else, so no stage can comment on, approve or change a pull request.
